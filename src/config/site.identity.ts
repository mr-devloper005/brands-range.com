export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'brands-range',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Brands Range',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'brands-range.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://brands-range.com',
